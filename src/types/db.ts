    ...
    Tables: {
      bills: {
        Row: {
          ...
          additional_fees_charge: number | null
          additional_fees_breakdown: Json | null
        }
        Insert: {
          id?: string
          BILLKEY?: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "bills_CUSTOMERKEY_fkey"
            columns: ["CUSTOMERKEY"]
            isOneToOne: false
      ...
      bulk_meter_readings: {
        ...
        Relationships: [
          {
            foreignKeyName: "bulk_meter_readings_CUSTOMERKEY_fkey"
            columns: ["CUSTOMERKEY"]
            isOneToOne: false
            referencedRelation: "bulk_meters"
            referencedColumns: ["customerKeyNumber"]
