...
export function BulkMeterTable({ data, onEdit, onDelete, branches, canEdit, canDelete }: BulkMeterTableProps) {
  ...
  return (
    <div className="mt-4">
      {/* Desktop Table View */}
      <div className="hidden md:block rounded-md border text-sm">
        <Table>
          <TableHeader>
            <TableRow>
          ...
          <Card key={bulkMeter.customerKeyNumber} className="overflow-hidden border shadow-sm">
            ...
            <CardContent className="p-4 space-y-3">
              <div className="grid grid-cols-2 gap-2 text-xs">
                ...
                <div><span className="text-muted-foreground uppercase font-semibold">Woreda:</span> {bulkMeter.woreda}</div>
