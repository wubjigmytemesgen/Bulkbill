...
export default function RolesAndPermissionsPage() {
  ...
  const handleSaveChanges = async () => {
    ...
    if (result.success) {
      ...
      // Re-fetch role permissions from the store to ensure UI is in sync
      // instead of a full reload if possible, but the store update already triggers subscriptions
      // We use reload as a fallback to clear any complex state.
      setTimeout(() => {
